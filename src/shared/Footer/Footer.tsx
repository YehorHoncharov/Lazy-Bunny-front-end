    ...
    <footer className="footer">
      ...
      <div className="div1">
        ...
        <div className="socialMedia">
          <div className="viber">
            <img
              className="footerSocMedia"
              src="/static/img/Viber.png"
              alt="Viber"
            />
            <a className="div1" href="/">
              Viber
      ...
      <div className="div2">
        <div className="footerNames">
          <a className="namefont" href="https://github.com/BohdanRubanov">
            Bohdanchik
          </a>
          <a className="namefont" href="https://github.com/arman455">
            Sema
          </a>
          <a className="namefont" href="https://github.com/YehorHoncharov">
            Egorushka
          </a>
        </div>
        <div className="footerTeam">
          <a className="namefont" href="/">
            Created by Team1
          </a>
          <a href="/">
            <img src="/static/img/FooterBunny.png" alt="FooterBunny" />
          </a>
        </div>
      </div>
    </footer>
